...
<html lang="es">
    ...
    <body>
        <div class="container mt-5 mb-5 border p-4">
            ...
            <form method="POST" action="/ByteCode/ServletPrincipal?accion=AgregarVenta">
                <div class="mb-3">
                    <label for="id_Cliente" class="form-label"> <strong> ID Cliente </strong></label>
                ...
                <div class="mb-3">
                    <label for="id_Pago" class="form-label"> <strong> ID Pago </strong></label>
                    <input type="number" class="form-control" name="id_Pago" id="id_Pago" required />
                </div>
                
                <div class="mb-3">
                    <label for="fechaVenta" class="form-label"> <strong> Fecha de Venta </strong></label>
