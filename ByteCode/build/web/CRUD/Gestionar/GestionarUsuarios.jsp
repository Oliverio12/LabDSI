            ...
            <c:forEach items="${listaUsuarios}" var="item">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">ID Empleado: ${item.id_Empleado}</p>
                            <p class="card-text">Nombre Completo: ${item.nombreCompleto}</p>
                            <p class="card-text">Rol: ${item.nombreRol}</p>
                            <p class="card-text">Usuario: ${item.usuario}</p>
                            <p class="card-text">Clave: ${item.clave}</p>
