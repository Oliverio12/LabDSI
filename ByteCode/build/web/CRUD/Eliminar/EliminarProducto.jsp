...
<html>
    ...
    <body>
        ...
        <form method="POST" action="/ByteCode/ServletPrincipal?accion=EliminarProducto">
            <div class="form-group">
                ...
                <label class="font-weight-bold">Inventario ${param.inventario}</label><br>
                <label class="font-weight-bold">ID Marca${param.id_Marca}</label><br>
                <label class="font-weight-bold">Marca${param.marca}</label><br>
                ...
                <input type="hidden" name="id_Producto" id="id_Producto" value="${param.id_Producto}" /><br><br>
                    <button type="submit" class="btn btn-danger" onclick="return confirm('¿Desea eliminar el Producto?')">Eliminar</button><br><br>
            </div>
            <div>
                <a class="btn btn-secondary" href="/ByteCode/?accion=GestionarProductos">Regresar</a><br><br>
            </div>             
        </form>
