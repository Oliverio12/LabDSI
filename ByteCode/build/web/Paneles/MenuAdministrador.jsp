        ...
        <div class="container text-center">
            ...
            <nav>
                <ul class="nav">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="/ByteCode?accion=GestionarCargos">Gestionar Cargos</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/ByteCode?accion=GestionarEmpleados">Gestionar Empleados</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/ByteCode?accion=GestionarUsuarios">Gestionar Usuarios</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/ByteCode?accion=GestionarClientes">Gestionar Clientes</a></li>
                    <li class="nav-item"> <a class="nav-link" href="/ByteCode?accion=GestionarInventario">Gestionar Inventario</a></li>
                    ...
                    <li class="nav-item"> <a class="nav-link" href="/ByteCode?accion=GestionarCompra">Gestionar Compra</a></li>
                    ...
                    <li class="nav-item"> <a class="nav-link" href="/ByteCode?accion=GestionarGrupos">Gestionar Grupos</a></li>
