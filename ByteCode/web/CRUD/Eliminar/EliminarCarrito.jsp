...
<html>
    ...
    <body>
        ...
        <form method="POST" action="/ByteCode/ServletPrincipal?accion=EliminarCarrito">
            <div class="form-group">
                ...
                <label class="font-weight-bold">Fecha Agregado: ${param.fechaAgregado}</label><br>
                
                <input type="hidden" name="id_Carrito" id="id_Carrito" value="${param.id_Carrito}" /><br><br>
                    <button type="submit" class="btn btn-danger" onclick="return confirm('¿Desea eliminar el Carrito?')">Eliminar</button><br><br>
            </div>
            <div>
                <a class="btn btn-secondary" href="/ByteCode/?accion=GestionarCarritos">Regresar</a><br><br>
            </div>             
        </form>
