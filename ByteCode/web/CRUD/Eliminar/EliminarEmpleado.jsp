...
<div class="container mt-5 mb-5 border p-4">
    ...
    <form method="POST" action="/ByteCode/ServletPrincipal?accion=EliminarEmpleado">
        <div class="form-group">
            ...
            <label class="font-weight-bold">Teléfono:</label> ${param.telefonoEmpleado}<br>
            <label class="font-weight-bold">Correo:</label> ${param.correo}<br>
            <label class="font-weight-bold">Cargo:</label> ${param.cargo}<br>
            <label class="font-weight-bold">Dirección:</label> ${param.direccionCompleta}
