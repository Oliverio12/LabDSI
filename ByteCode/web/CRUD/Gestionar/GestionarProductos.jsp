...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="action-buttons">
                                ...
                                <div class="popup-container" id="popup">
                                    ...
                                    <label class="font-weight-bold">Descripción<span id="descripcion" class="text-info"></span></label>
                                    <!-- Otras etiquetas para detalles -->
    ...
    <script>
        ...
        function mostrarDetallesProductos(id_Producto, nombreProducto, descripcion, precio, inventario, marca, categoria) {
            ...
            // Actualiza otras etiquetas con detalles
            // Muestra el pop-up
            abrirPopup();
        }
    </script>
